...
function AcceptanceEvidence({ report, result, experiment }: {
  ...
  const source = experiment.phy.rx_quality_mode === "ModeledBpskAwgn"
    ? "Modeled · 仿真模型 BER（BPSK/AWGN），不是硬件实测；高 SNR 下 0.0 可能表示已达到浮点数值表示下限"
